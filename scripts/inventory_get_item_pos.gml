...
return inventory_get_item_slot_x_raw(argument0) + global.ui_inventory.x - sprite_get_xoffset(global.ui_inventory.sprite_index);

#define inventory_get_item_slot_y
/// inventory_get_item_slot_y(index)

return inventory_get_item_slot_y_raw(argument0) + global.ui_inventory.y - sprite_get_yoffset(global.ui_inventory.sprite_index);
