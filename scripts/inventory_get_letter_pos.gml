...
return 200 + 24 * (argument0 mod 2) + global.ui_inventory.x - sprite_get_xoffset(global.ui_inventory.sprite_index);

#define inventory_get_letter_slot_y
/// inventory_get_letter_slot_y(index)

return 39 + 24 * (argument0 div 2) + global.ui_inventory.y - sprite_get_yoffset(global.ui_inventory.sprite_index);
